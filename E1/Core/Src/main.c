...
int main(void)
{
  ...
  // For the data type to be executed, the main.h library must be included.
  // Initialize the button_value in 0
  ...
  // I joined the two exercises, because they are practically the same.
